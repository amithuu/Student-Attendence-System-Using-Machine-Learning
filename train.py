...
class Train:
    def __init__(self,root):
        ...
        img_top=Image.open(r"Camera Roll\first.jpeg")
        ...
        img_bottom=Image.open(r"Camera Roll\attendence.jpeg")
    ...
    def train_classifier(self):
        ...
        for image in path:
            img=Image.open(image).convert('L') # used to convert image to gray scale
            imageNp=np.array(img,'uint8') # datatype in array
        ...
        messagebox.showinfo("Result","Training dat set completed")
